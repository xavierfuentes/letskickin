...
class Participant
{
	...
	/**
     * @ORM\ManyToOne(targetEntity="Application\Letskickin\CoreBundle\Entity\Pot", inversedBy="participants", cascade={"persist"})
     */
    protected $pot;
     ...
     * Set pot
     *
     * @param \Application\Letskickin\CoreBundle\Entity\Pot $pot
     * @return Participant
     */
    public function setPot(\Application\Letskickin\CoreBundle\Entity\Pot $pot = null)
    {
        $this->pot = $pot;
     ...
     * Get pot
     *
     * @return \Application\Letskickin\CoreBundle\Entity\Pot
     */
